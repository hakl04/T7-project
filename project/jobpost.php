...
<body>
    ...
    <section class="aform">
        <form action="process_job.php" method="post">
            ...
            if(isset($_SESSION['application_deadline'])){
                $application_deadline = $_SESSION['application_deadline'];
            }
            ...
            if(isset($_SESSION['scope_of_work'])){
                $scope_of_work = $_SESSION['scope_of_work'];
            }
            if(isset($_SESSION['experience_requirement'])){
                $experience_requirement = $_SESSION['experience_requirement'];
            }
            if(isset($_SESSION['benefits'])){
                $benefits = $_SESSION['benefits'];
            }
            if(isset($_SESSION['company_introduction'])){
                $company_introduction = $_SESSION['company_introduction'];
            }
            if(isset($_SESSION['specialization_name_job'])){
                $specialization_name = $_SESSION['specialization_name_job'];
            }
            echo"
            ...
            <div id="form-group-final">
                <input type="submit" value="Submit" class="snr">

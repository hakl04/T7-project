...
<html>
    ...
    <body>
        ...
        <section id="job-search">
            <h2>Applied Candidate Profile:</h2>
            <table class='result-table'>
                ...
                $candidate_id = $lastrow['candidate_id'];
        ...
        <form action="candidate.php" method="POST">
			<?php
				echo"
                <input type='hidden' name='button' value=$application_id/>
                <input type='submit' formaction='application_accept.php' value='Accept'>
                <input type='submit' formaction='application_deny.php' value='Deny'>
				 ";
			?>

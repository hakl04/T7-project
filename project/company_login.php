...
<body>
    ...
    <section class="aform">
        <form action="process_company_login.php" method="post">
            ...
            if(isset($_SESSION['company_login_error'])){
                echo $_SESSION['company_login_error'];
                $_SESSION['company_login_error'] = "";
            }
            echo"
            </div>";
            ?>
            ...
            <div id="form-group-final">
                ...
                <input type="submit" formaction='process_company_register.php' value="Register" class="snr">
            </div>
            </fieldset>
        </form>
    </section>
